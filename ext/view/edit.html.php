  ...
  <div class='center-block'>
    ...
    <form id='webhookForm' method='post' class='form-ajax'>
      <table class='table table-form'>
        ...
        <?php endif;?>
        <?php if($webhook->type == 'mmuser'):?>
        <?php $secret = json_decode($webhook->secret);?>
        <tr class='mmTR'>
          <th><?php echo $lang->webhook->mmAgentId;?></th>
          <td class='required'><?php echo html::input('mmAgentId', $secret->agentId, "class='form-control'")?></td>
        </tr>
        <tr class='mmTR'>
          <th><?php echo $lang->webhook->mmToken;?></th>
          <td class='required'><?php echo html::input('mmToken', $secret->appSecret, "class='form-control'")?></td>
          <td></td>
        </tr>
        <?php endif;?>
        <tr>
        ...
        <?php if(strpos("dinggroup|dinguser|wechatgroup|wechatuser|feishuuser|feishugroup|mmuser", $webhook->type) === false):?>
        <tr>
        ...
        <?php if(strpos(',bearychat,dinggroup,dinguser,wechatgroup,wechatuser,feishuuser,feishugroup,mmuser,', ",$webhook->type,") === false):?>
        <tr id='paramsTR'>
          <th>
